...
// === Main Animation Timeline Demi Obet Tercinta ===
const animationTimeline = () => {
  ...
  // Confetti Balloon Animation (absurd)
  gsap.utils.toArray(".baloons img").forEach((el) => {
    gsap.fromTo(el, {
      y: "100vh",
  ...
  // Akhir Kocak dan Warna-Warni
  tl.staggerFrom(".nine p", 1, ideaTextTrans, 1.2)
    .to(".last-smile", 0.5, { rotation: 720, scale: 1.5, ease: Bounce.easeOut })
    .to(".container", 1, { backgroundColor: "#ffebf0" });
